  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <el-input v-model="query.id" clearable placeholder="用户ID" style="width: 185px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-permission="['admin','abcd:edit','abcd:del']" label="操作" width="150px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
export default {
  ...
  cruds() {
    return CRUD({ title: 'api/abcd', url: 'api/abcd', idField: 'id', sort: 'id,desc', crudMethod: { ...crudAbcd }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'abcd:add'],
        edit: ['admin', 'abcd:edit'],
        del: ['admin', 'abcd:del']
      },
      rules: {
        field1: [
